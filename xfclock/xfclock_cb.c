...
void font_cb(GtkWidget *widget, gpointer data)
{
   char *fnt;
...
void foreground_cb(GtkWidget *widget, gpointer data)
{
   gdouble colors[4];
   gdouble *newcolor;
   GtkStyle *style, *newstyle;
...
void background_cb(GtkWidget *widget, gpointer data)
{
   gdouble colors[4];
   gdouble *newcolor;
   GtkStyle *style, *newstyle;
...
show_popup_cb (GtkWidget *widget, GdkEventButton *event, gpointer data) 
{
  ...
  if (!clock_popup_menu) clock_make_popup (MY_GTK_CLOCK (data));
...
void toggle_menubar_cb(GtkWidget *widget, gpointer data)
{
...
void toggle_calendar_cb(GtkWidget *widget, gpointer data)
{
...
void toggle_digital_cb(GtkWidget *widget, gpointer data)
{
