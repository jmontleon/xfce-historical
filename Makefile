...
install.sample::
	...
	@(cd $(DEST_XFCE);	$(RM) -f system.fvwmrc;ln -sf sample.fvwmrc  system.fvwmrc;	$(RM) -f system.fvwm2rc;ln -sf sample.fvwm2rc system.fvwm2rc;	$(RM) -f system.xfwmrc;ln -sf sample.xfwmrc  system.xfwmrc;	$(RM) -f system.xsession;ln -sf sample.xsession system.xsession;)

	@(cd $(DEST_XFCE);	$(RM) -f .xfcerc;ln -sf sample.xfcerc  .xfcerc;	$(RM) -f .xinitrc;ln -sf sample.xinitrc .xinitrc;	$(RM) -f .xfbdrc;ln -sf sample.xfbdrc  .xfbdrc;	$(RM) -f .xfsoundrc;ln -sf sample.xfsoundrc  .xfsoundrc;	$(RM) -f sample.xsession;ln -sf sample.Xclients sample.xsession;)
...
install:: install.palettes install.help install.icons install.backdrops  install.sounds install.sample install.bin install.dt

	@if [ ! -d /var/XFCE ]; then 	ln -s $(DEST_XFCE) /var/XFCE; fi
