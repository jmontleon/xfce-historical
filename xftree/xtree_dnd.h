...
void on_drag_leave (GtkWidget *tree, GdkDragContext *con, guint time, void *p);
gboolean on_drag_drop (GtkWidget *, GdkDragContext *,gint, gint, guint,
			gpointer);
gboolean on_drag_motion (GtkWidget *w, GdkDragContext *c, gint x, gint y,
...
void on_drag_begin (GtkWidget *ctree, GdkDragContext *context, void *data);
