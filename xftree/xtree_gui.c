...
move_dir (char *source, char *label, char *target, int trash)
{
	...
	if (mkdir (new_path, 0xFFFFFFFF) == -1) {
		perror (source);
		closedir(dir);
		return (FALSE);
	}
...
cb_find (GtkWidget *item, GtkWidget *ctree)
{
	...
	if (dlg_string (path, pattern) == DLG_RC_OK) {
		sprintf (path, "xterm -e sh -c \"find %s -name '%s' -print | more ; echo Press ENTER; read\"",
			en->path, pattern);
		io_system (path);
	}
}
			...
			int flags)
{
	...
	menu_entry dir_mlist[] = {
		{ N_("Open in new"),		cb_new_window,		0},
		{ NULL,				NULL,			0},
		{ N_("New Folder ..."),		cb_new_subdir,		0, GDK_n, GDK_MOD1_MASK},
		{ N_("New file ..."),		cb_new_file,		0, GDK_k, GDK_MOD1_MASK},
		{ NULL,				NULL,			0},
		{ N_("Rename ..."),		cb_rename,		0, GDK_r, GDK_MOD1_MASK},
		{ N_("Delete ..."),		cb_delete,		0, GDK_x, GDK_CONTROL_MASK},
		{ NULL,				NULL,			0},
		{ N_("Go to ..."),		cb_go_to,		0},
		{ N_("Go to marked"),		cb_go_to,		0, GDK_g, GDK_MOD1_MASK},
		{ N_("Go up"),			cb_go_up,		0, GDK_u, GDK_MOD1_MASK},
		{ N_("Go home"),		cb_go_home,		0, GDK_h, GDK_MOD1_MASK},
		{ NULL,				NULL,			0},
		{ N_("Unselect"),		cb_unselect,		0, GDK_a, GDK_SHIFT_MASK|GDK_MOD1_MASK},
		{ N_("Select all"),		cb_select,		0, GDK_a, GDK_MOD1_MASK},
		{ N_("Unselect all"),		cb_unselect,		0},
		{ N_("Find ..."),		cb_find,		0, GDK_f, GDK_MOD1_MASK},
		{ N_("Toggle Dotfiles"),	on_dotfiles,		0, GDK_D, GDK_SHIFT_MASK|GDK_MOD1_MASK},
		{ NULL,				NULL,			0},
		{ N_("Properties ..."),		cb_props, 		0, GDK_i, GDK_MOD1_MASK},
		{ NULL,				NULL,			0},
		{ N_("Empty Trash"),		cb_empty_trash,		0, GDK_e, GDK_MOD1_MASK},
		{ N_("Open Trash"),		cb_open_trash, 		WINCFG, GDK_t, GDK_MOD1_MASK},
		{ N_("About ..."),		cb_about,		0, GDK_a, GDK_CONTROL_MASK},
		{ NULL,				NULL,			0},
		{ N_("Run program ..."),	cb_exec, 		WINCFG},
		{ N_("Close window"),		cb_destroy, 		TOPWIN, GDK_w, GDK_MOD1_MASK},
		{ N_("Quit"),			gtk_main_quit, 		0, GDK_q, GDK_MOD1_MASK},
	};
	#define LAST_DIR_MENU_ENTRY (sizeof(dir_mlist)/sizeof(menu_entry))

	menu_entry file_mlist[] = {
		{ N_("New window"),		cb_new_window,		0},
		{ NULL,				NULL,			0},
		{ N_("Open with ..."),		cb_open_with,		0, GDK_o, GDK_MOD1_MASK},
		{ NULL,				NULL,			0},
		{ N_("Rename ..."),		cb_rename,		0, GDK_r, GDK_MOD1_MASK},
		{ N_("Delete ..."),		cb_delete,		0, GDK_x, GDK_CONTROL_MASK},
		{ N_("Duplicate"),		cb_duplicate,		0, GDK_d, GDK_MOD1_MASK},
		{ NULL,				NULL,			0},
		{ N_("Go to ..."),		cb_go_to,		0},
		{ N_("Go up"),			cb_go_up,		0, GDK_u, GDK_MOD1_MASK},
		{ N_("Go home"),		cb_go_home,		0, GDK_h, GDK_MOD1_MASK},
		...
		{ NULL,				NULL,			0},
		{ N_("Properties ..."),		cb_props,		0, GDK_i, GDK_MOD1_MASK},
		{ N_("Register ..."),		cb_register,		0, GDK_j, GDK_MOD1_MASK},
		{ NULL,				NULL,			0},
		{ N_("Empty Trash"),		cb_empty_trash,		0, GDK_e, GDK_MOD1_MASK},
		{ N_("Open Trash"),		cb_open_trash, 		WINCFG, GDK_t, GDK_MOD1_MASK},
		{ N_("About ..."),		cb_about,		0, GDK_a, GDK_CONTROL_MASK},
	...
	menu_entry mixed_mlist[] = {
		{ N_("New windows"),		cb_new_window,		0},
		{ NULL,				NULL,			0},
		{ N_("Delete ..."),		cb_delete,		0, GDK_x, GDK_CONTROL_MASK},
		{ NULL,				NULL,			0},
		{ N_("Go to ..."),		cb_go_to,		0},
		...
		{ N_("Toggle Dotfiles"),	on_dotfiles,		0, GDK_D, GDK_SHIFT_MASK|GDK_MOD1_MASK},
		{ NULL,				NULL,			0},
		{ N_("Empty Trash"),		cb_empty_trash,		0},
		{ N_("Open Trash"),		cb_open_trash,		WINCFG},
		{ NULL,				NULL,			0},
		{ N_("Empty Trash"),		cb_empty_trash,		0, GDK_e, GDK_MOD1_MASK},
		{ N_("Open Trash"),		cb_open_trash, 		WINCFG, GDK_t, GDK_MOD1_MASK},
		{ N_("About ..."),		cb_about,		0, GDK_a, GDK_CONTROL_MASK},
	...
	menu_entry none_mlist[] = {
		{ N_("New window"),		cb_new_window,		0},
		{ NULL,				NULL,			0},
		{ N_("New Folder ..."),		cb_new_subdir,		0},
		{ N_("New file ..."),		cb_new_file,		0, GDK_k, GDK_MOD1_MASK},
		{ NULL,				NULL,			0},
		{ N_("Go to ..."),		cb_go_to,		0},
		{ N_("Go up"),			cb_go_up,		0, GDK_u, GDK_MOD1_MASK},
		{ N_("Go home"),		cb_go_home,		0},
		{ NULL,				NULL,			0},
		{ N_("Select all"),		cb_select,		0, GDK_a, GDK_MOD1_MASK},
		{ N_("Unselect all"),		cb_unselect,		0},
		{ N_("Toggle Dotfiles"),	on_dotfiles,		0, GDK_D, GDK_SHIFT_MASK|GDK_MOD1_MASK},
	...
	gtk_menu_attach_to_widget(GTK_MENU(menu[MN_NONE]),ctree,menu_detach);
	...
	gtk_drag_source_set (ctree, GDK_BUTTON2_MASK, target_table, NUM_TARGETS, GDK_ACTION_MOVE|GDK_ACTION_COPY);
	gtk_drag_dest_set (ctree, GTK_DEST_DEFAULT_ALL, target_table, NUM_TARGETS, GDK_ACTION_MOVE|GDK_ACTION_COPY);
