...
/*
 */
static XFCE_palette *global_pal;
	 ...
	 int height, int flags)
{
  ...
  menu_entry dir_mlist[] = {
    ...
    {N_("Unselect"), (void *) cb_unselect, 0, GDK_a,
    ...
    {N_("Toggle Dotfiles"), (void *) on_dotfiles, 0, GDK_D,
     GDK_SHIFT_MASK | GDK_MOD1_MASK},
    {NULL, NULL, 0},
	  ...
	  wgeo_t * geo, int flags)
{
  ...
  gPIX_page_lnk =
    MyCreateGdkPixmapFromData (page_lnk_xpm, top, &gPIM_page_lnk);
  gPIX_dir_pd = MyCreateGdkPixmapFromData (dir_pd_xpm, top, &gPIM_dir_pd);
  gPIX_dir_open =
    MyCreateGdkPixmapFromData (dir_open_xpm, top, &gPIM_dir_open);
  gPIX_dir_open_lnk =
    MyCreateGdkPixmapFromData (dir_open_lnk_xpm, top, &gPIM_dir_open_lnk);
  gPIX_dir_close =
    MyCreateGdkPixmapFromData (dir_close_xpm, top, &gPIM_dir_close);
  gPIX_dir_close_lnk =
    MyCreateGdkPixmapFromData (dir_close_lnk_xpm, top, &gPIM_dir_close_lnk);
  ...
  gPIX_char_dev =
    MyCreateGdkPixmapFromData (char_dev_xpm, top, &gPIM_char_dev);
  gPIX_block_dev =
    MyCreateGdkPixmapFromData (block_dev_xpm, top, &gPIM_block_dev);
  ...
  gPIX_stale_lnk =
    MyCreateGdkPixmapFromData (stale_lnk_xpm, top, &gPIM_stale_lnk);
