...
static void my_handler_paint (GtkWidget * widget, GdkRectangle * area);
static void my_handler_draw (GtkWidget * widget, GdkRectangle * area);
static void my_handler_size_request (GtkWidget * widget,
				     GtkRequisition * requisition);
static void my_handler_size_allocate (GtkWidget * widget,
				      GtkAllocation * allocation);
static gint my_handler_expose (GtkWidget * widget, GdkEventExpose * event);

/* Local data */

static GtkBinClass *parent_class = NULL;

guint my_handler_get_type ()
{
...
static void
my_handler_size_allocate (GtkWidget * widget, GtkAllocation * allocation)
{
  MyHandler *handle;
  GtkBin *bin;
...
static void
my_handler_size_request (GtkWidget * widget, GtkRequisition * requisition)
{
  MyHandler *handle;
  GtkBin *bin;
  gint tmp_height;
...
static gint
my_handler_expose (GtkWidget * widget, GdkEventExpose * event)
{
  GtkBin *bin;
...
static void
my_handler_paint (GtkWidget * widget, GdkRectangle * area)
{
  MyHandler *handle;
  gint x, y;
...
static void
my_handler_draw (GtkWidget * widget, GdkRectangle * area)
{
  MyHandler *handle;
