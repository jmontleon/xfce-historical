...
#ifndef DEFAULTFONT
#define DEFAULTFONT 	"-adobe-helvetica-medium-r-normal-*-10-*-*-*-*-*-iso8859-*"
#endif

#ifndef TIPFONT
#define TIPFONT 	"-adobe-helvetica-medium-r-normal-*-12-*-*-*-*-*-iso8859-*"
#endif
...
#define XFCE_BACKDROPS 	"/backdrops/*.xpm"
#endif

#ifndef XFCE_ICONS
#define XFCE_ICONS 	"/icons/*.xpm"
#endif

#ifndef XFCE_SOUNDS
#define XFCE_SOUNDS 	"/sounds/*.wav"
#endif
...
#define XFWM_TITLEFONT 	"-*-helvetica-medium-r-*-*-12-*-*-*-*-*-*-*"
#endif

#ifndef XFWM_MENUFONT
#define XFWM_MENUFONT 	"-*-helvetica-medium-r-*-*-10-*-*-*-*-*-*-*"
#endif

#ifndef XFWM_ICONFONT
#define XFWM_ICONFONT 	"-*-helvetica-medium-r-*-*-10-*-*-*-*-*-*-*"
#endif
