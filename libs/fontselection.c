...
open_fontselection (char *init)
{
  ...
  gtk_object_set_data (GTK_OBJECT (fontselectiondialog),
  ...
  gtk_object_set_data (GTK_OBJECT (fontselectiondialog), "ok_button",
		       ok_button);
  ...
  gtk_object_set_data (GTK_OBJECT (fontselectiondialog), "cancel_button",
		       cancel_button);
  ...
  gtk_object_set_data (GTK_OBJECT (fontselectiondialog), "apply_button",
		       apply_button);
  ...
  gtk_signal_connect (GTK_OBJECT (ok_button), "clicked",
		      GTK_SIGNAL_FUNC (ok_cb), (gpointer) fontname);
  ...
  gtk_signal_connect (GTK_OBJECT (fontselectiondialog), "destroy",
		      GTK_SIGNAL_FUNC (delete_event), NULL);

  if (init)
    gtk_font_selection_dialog_set_font_name (GTK_FONT_SELECTION_DIALOG
					     (fontselectiondialog), init);
