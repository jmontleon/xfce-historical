...
#define AnimateWin              (1<<11)
#define MoveOpaqueWin           (1<<12)
#define AutoRaiseWin            (1<<13)
#define SHOW_ON_MAP             (1<<14)
#define BORDER                  (1<<15)
#define TITLE                   (1<<16)
#define MAPPED                  (1<<17)
#define ICONIFIED               (1<<18)
#define TRANSIENT               (1<<19)
#define RAISED                  (1<<20)
#define VISIBLE                 (1<<21)
#define ICON_OURS               (1<<22)
#define PIXMAP_OURS             (1<<23)
#define SHAPED_ICON             (1<<24)
#define MAXIMIZED               (1<<25)
#define DoesWmTakeFocus		(1<<26)
#define DoesWmDeleteWindow	(1<<27)
#define ICON_MOVED              (1<<28)
#define ICON_UNMAPPED           (1<<29)
#define MAP_PENDING             (1<<30)
#define RAISEDWIN               (1<<31) /* Used for autoraise facility */
...
extern Atom _XA_XFWM_STICKS_TO_GLASS;
extern Atom _XA_XFWM_CLIENT;
