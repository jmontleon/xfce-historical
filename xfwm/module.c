		...
		unsigned long context, char *action, int *Module)
{
  ...
  if (*Module >= 0)
	...
	{
	  SendConfig (*Module, XFCE_M_CONFIGURE_WINDOW, t);
	  SendName (*Module, XFCE_M_WINDOW_NAME, t->w, t->frame,
		    (unsigned long) t, t->name);
	  SendName (*Module, XFCE_M_ICON_NAME, t->w, t->frame,
		    (unsigned long) t, t->icon_name);
	  if (t->icon_bitmap_file != NULL &&
	      t->icon_bitmap_file != Scr.DefaultIcon)
	    SendName (*Module, XFCE_M_ICON_FILE, t->w, t->frame,
		      (unsigned long) t, t->icon_bitmap_file);
	  SendName (*Module, XFCE_M_RES_CLASS, t->w, t->frame,
		    (unsigned long) t, t->class.res_class);
	  SendName (*Module, XFCE_M_RES_NAME, t->w, t->frame,
		    (unsigned long) t, t->class.res_name);

	  if (t->flags & ICONIFIED)
            {
              if (!(t->flags & ICON_UNMAPPED))
 	        SendPacket (*Module, XFCE_M_ICONIFY, 7, t->w, t->frame,
			    (unsigned long) t,
