...
#define BW_FLAG              (1<<17)
#define FORE_COLOR_FLAG      (1<<18)
#define BACK_COLOR_FLAG      (1<<19)
#define MWM_BUTTON_FLAG      (1<<20)
#define MWM_DECOR_FLAG       (1<<21)
#define MWM_FUNCTIONS_FLAG   (1<<22)
#define MWM_OVERRIDE_FLAG    (1<<23)
#define NO_PPOSITION_FLAG    (1<<24)
...
extern void MoveOutline (XfwmWindow *, int, int, int, int);
extern void DisplayPosition (XfwmWindow *, int, int, int, int);
extern void DoResize (int, int, XfwmWindow *);
extern void SetupFrame (XfwmWindow *, int, int, int, int, Bool, Bool);
...
extern Bool moveLoop (XfwmWindow *, int, int, int, int, int *, int *, Bool,
		      Bool);
...
extern void RelieveWindow (XfwmWindow *, Window,
...
extern void Maximize (XEvent * eventp, Window w, XfwmWindow * tmp_win,
		      unsigned long context, char *action, int *Module);
extern void Shade (XfwmWindow * tmp_win);
extern void Unshade (XfwmWindow * tmp_win);
extern void shade_function (XEvent * eventp, Window w, XfwmWindow * tmp_win,
			    unsigned long context, char *action, int *Module);
extern void RaiseWindow (XfwmWindow * t);
extern void LowerWindow (XfwmWindow * t);
extern void MyXGrabButton (Display *, unsigned int, unsigned int,
			   Window, Bool, unsigned int, int, int, Window,
			   Cursor);
extern void MyXUngrabButton (Display *, unsigned int, unsigned int, Window);
extern void MyXGrabKey (Display *, int, unsigned int, Window, Bool, int, int);
extern void MyXUngrabKey (Display *, int, unsigned int, Window);
...
extern void AutoPlace (XfwmWindow *, Bool);
extern Bool CheckIconPlace (XfwmWindow *);
...
void ComplexFunction (XEvent * eventp, Window w, XfwmWindow * tmp_win,
		      unsigned long context, char *action, int *Module);
extern int DeferExecution (XEvent *, Window *, XfwmWindow **, unsigned long *,
			   int, int);
void my_sleep (int);
...
void RelieveRectangle (Window win, int x, int y, int w, int h, GC Hilite,
		       GC Shadow);
void RelieveHalfRectangle (Window win, int x, int y, int w, int h, GC Hilite,
			   GC Shadow, int Top);
...
void AddToList (char *name, char *icon_name,
		unsigned long off_flags,
		unsigned long on_flags, int desk, int bw,
		char *forecolor, char *backcolor,
...
void SetIconSpacing (XEvent * eventp, Window w, XfwmWindow * tmp_win,
		     unsigned long context, char *action, int *Module);
void use_bitmap_buttons (XEvent * eventp, Window w, XfwmWindow * tmp_win,
			 unsigned long context, char *action, int *Module);
