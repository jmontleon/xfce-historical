...
#define RANDOM_PLACE_FLAG    (1<<20)
#define SMART_PLACE_FLAG     (1<<21)
#define MWM_BUTTON_FLAG      (1<<22)
#define MWM_DECOR_FLAG       (1<<23)
#define MWM_FUNCTIONS_FLAG   (1<<24)
#define MWM_OVERRIDE_FLAG    (1<<25)
#define NO_PPOSITION_FLAG    (1<<26)
#define OL_DECOR_FLAG        (1<<27)
...
extern Bool moveLoop (XfwmWindow *, int, int, int, int, int *, int *, Bool, Bool);
...
void RelieveHalfRectangle (Window win, int x, int y, int w, int h,GC Hilite, GC Shadow, int Top);
...
Bool InteractiveMove (Window * w, XfwmWindow * tmp_win, int *FinalX, int *FinalY,
		      XEvent * eventp);
...
void changeDesks_func (XEvent * eventp, Window w, XfwmWindow * tmp_win,
		       unsigned long context, char *action, int *Module);
void changeDesks (int, int, Bool, Bool);
