...
GetShadow (Pixel background)
{
  ...
  bg_color.red = shift (bg_color.red, 60);
  bg_color.green = shift (bg_color.green, 60);
  bg_color.blue = shift (bg_color.blue, 60);
...
GetHilite (Pixel background)
{
  ...
  r = shift (bg_color.red, 125);
  g = shift (bg_color.green, 125);
  b = shift (bg_color.blue, 125);
