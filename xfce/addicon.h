...
extern void show_addiconform (char *);
extern void hide_addiconform (void);
...
int addicon_atclose (FL_FORM *, long *);
...
extern FD_addiconform *create_form_addiconform (Pixmap, Pixmap);
