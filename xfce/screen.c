...
GtkWidget*
create_screen (XFCE_palette * pal)
{
  GtkWidget *screen;
  ...
  gtk_table_attach (GTK_TABLE (screen_table), screen_displayed_label, 0, 1, 0, 1,
  ...
  /* gtk_widget_set_style(screen_displayed_entry, pal->cm[4]); */
  gtk_widget_show (screen_displayed_entry);
  gtk_table_attach (GTK_TABLE (screen_table), screen_displayed_entry, 1, 2, 0, 1,
                    (GtkAttachOptions) GTK_EXPAND | GTK_FILL, (GtkAttachOptions) GTK_EXPAND | GTK_FILL, 0, 0);
...
void
open_screen(GtkWidget *screen, int scr_number)
{
  screen_signal_id = gtk_signal_connect (GTK_OBJECT (screen_ok_button), "clicked",
