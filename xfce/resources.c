...
create_resources (res_XFCE * r)
{
  ...
  r->setupgradient = (char *) malloc (TEXTLEN);
  r->setupdetach = (char *) malloc (TEXTLEN);
  r->clicktofocus = (char *) malloc (TEXTLEN);
  r->autoraise = (char *) malloc (TEXTLEN);
  r->opaquemove = (char *) malloc (TEXTLEN);
...
load_resources (res_XFCE * r)
{
  FL_resource res[] =
  {
    ...
    {
      "setup.clicktofocusText",
      "XForm.clicktofocusText",
      FL_STRING,
      r->clicktofocus,
    ...
    {
      "setup.opaquemoveText",
      "XForm.opaquemoveText",
      FL_STRING,
      r->opaquemove,
    ...
    },
    {
      ...
      FL_STRING,
      r->FVWMonly,
      "Warning\nThis function works only with XFwm !\nSee XFwm man page",
      TEXTLEN
    },
    {
    ...
    {
      "menu.detachheight",
      "XForm.menu.detachheight",
      FL_INT,
      &(r->detachheight),
      "9",
    },
  };
  fl_get_app_resources (res, NB_RESOURCES);
}
