...
static int private_action_menu_selected = -1;

GtkWidget*
create_action (XFCE_palette *pal)
{
  GtkWidget *action;
  ...
  gtk_table_attach (GTK_TABLE (action_table), action_command_label, 0, 1, 0, 1,
  ...
  /* gtk_widget_set_style(action_command_entry, pal->cm[4]); */
  gtk_widget_show (action_command_entry);
  gtk_table_attach (GTK_TABLE (action_table), action_command_entry, 1, 2, 0, 1,
                    (GtkAttachOptions) GTK_EXPAND | GTK_FILL, (GtkAttachOptions) GTK_EXPAND | GTK_FILL, 0, 0);
  ...
  gtk_table_attach (GTK_TABLE (action_table), action_icon_optionmenu, 1, 2, 1, 2,
  ...
  gtk_table_attach (GTK_TABLE (action_table), action_icon_browse_button, 2, 3, 1, 2,
                    (GtkAttachOptions) GTK_EXPAND | GTK_FILL, (GtkAttachOptions) GTK_EXPAND, 0, 0);
  ...
  gtk_table_attach (GTK_TABLE (action_table), action_command_browse_button, 2, 3, 0, 1,
                    (GtkAttachOptions) GTK_EXPAND | GTK_FILL, (GtkAttachOptions) GTK_EXPAND, 0, 0);
...
void private_action_update_menuentry_cb( GtkWidget *widget,
                     gpointer   data )
{
  private_action_menu_selected = (int) data;
}
...
action_addto_choice(char *name)
{
  ...
  if (name && strlen (name)) {
    ...
    gtk_signal_connect (GTK_OBJECT (menuitem), "activate",
			    GTK_SIGNAL_FUNC (private_action_update_menuentry_cb),
			    (gpointer) position++);
...
void
action_set_choice_selected(int index)
{
...
void
open_action(GtkWidget *action, int nbr)
{
  ...
  action_signal_id1 = gtk_signal_connect (GTK_OBJECT (action_ok_button), "clicked",
				 GTK_SIGNAL_FUNC (action_ok_cb),
				 (gpointer) nbr);
  action_signal_id2 = gtk_signal_connect (GTK_OBJECT (action_icon_browse_button), "clicked",
