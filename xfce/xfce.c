...
create_gxfce_select_button (GtkWidget *toplevel, XFCE_palette * pal, gint nbr)
{
  ...
  select_buttons.select_tooltips[nbr] = my_tooltips_new();
...
create_gxfce (XFCE_palette *pal)
{
  ...
  gxfce_clock_tooltip = my_tooltips_new();
  ...
  select_buttons.select_tooltips[NBSELECTS] = my_tooltips_new();
  ...
  gxfce_info_tooltip = my_tooltips_new();
  ...
  gxfce_setup_tooltip = my_tooltips_new();
  ...
  gxfce_quit_tooltip = my_tooltips_new();
