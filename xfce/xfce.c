...
update_gxfce_size (void)
{
  ...
  reorganize_table ((GtkTable *) (gxfce_rightbuttons_table), 
                    ...
                    2, 
                    (size == 0) ? 1 : 2);
  gtk_container_border_width (GTK_CONTAINER (gxfce_clock_event), 
                              ((size == 0) ? 0 : 5));
...
create_gxfce_popup_button (GtkWidget * toplevel, gint nbr)
{
  ...
  gtk_button_set_relief ((GtkButton *) popup_buttons.popup_button[nbr],
			 GTK_RELIEF_NONE);
  gtk_widget_set_name (popup_buttons.popup_button[nbr], "gxfce_color7");
#else
...
create_gxfce (XFCE_palette *pal)
{
  ...
  gtk_button_set_relief ((GtkButton *) gxfce_close_button,
			 GTK_RELIEF_NONE);
  gtk_widget_set_name (gxfce_close_button, "gxfce_color7");
#else
  ...
  gtk_button_set_relief ((GtkButton *) gxfce_iconify_button,
			 GTK_RELIEF_NONE);
  gtk_widget_set_name (gxfce_iconify_button, "gxfce_color7");
#else
