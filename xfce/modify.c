...
GtkWidget*
create_modify (XFCE_palette * pal)
{
  GtkWidget *modify;
  ...
  /* gtk_widget_set_style(modify_preview_frame, pal->cm[7]); */
  ...
  /* gtk_widget_set_style(modify_preview_pixmap, pal->cm[7]); */
  ...
  gtk_table_attach (GTK_TABLE (modify_table), modify_command_label, 0, 1, 0, 1,
  ...
  gtk_table_attach (GTK_TABLE (modify_table), modify_displayed_label, 0, 1, 2, 3,
                    (GtkAttachOptions) GTK_EXPAND | GTK_FILL, (GtkAttachOptions) GTK_EXPAND | GTK_FILL, 0, 0);
  ...
  /* gtk_widget_set_style(modify_command_entry, pal->cm[4]); */
  gtk_widget_show (modify_command_entry);
  gtk_table_attach (GTK_TABLE (modify_table), modify_command_entry, 1, 2, 0, 1,
                    (GtkAttachOptions) GTK_EXPAND | GTK_FILL, (GtkAttachOptions) GTK_EXPAND | GTK_FILL, 0, 0);
  ...
  /* gtk_widget_set_style(modify_icon_entry, pal->cm[4]); */
  ...
  /* gtk_widget_set_style(modify_displayed_entry, pal->cm[4]); */
  gtk_widget_show (modify_displayed_entry);
  gtk_table_attach (GTK_TABLE (modify_table), modify_displayed_entry, 1, 2, 2, 3,
                    (GtkAttachOptions) GTK_EXPAND | GTK_FILL, (GtkAttachOptions) GTK_EXPAND | GTK_FILL, 0, 0);
  ...
  gtk_table_attach (GTK_TABLE (modify_table), modify_command_browse_button, 2, 3, 0, 1,
  ...
  gtk_table_attach (GTK_TABLE (modify_table), modify_icon_browse_button, 2, 3, 1, 2,
                    (GtkAttachOptions) GTK_EXPAND | GTK_FILL, (GtkAttachOptions) GTK_EXPAND, 0, 0);
  ...
  gtk_signal_connect (GTK_OBJECT (modify), "destroy",
  ...
  gtk_signal_connect (GTK_OBJECT (modify_command_browse_button), "clicked",
				 GTK_SIGNAL_FUNC (modify_browse_command_cb),
				 NULL);

  gtk_signal_connect (GTK_OBJECT (modify_icon_browse_button), "clicked",
				 GTK_SIGNAL_FUNC (modify_browse_icon_cb),
				 NULL);
...
void
open_modify(GtkWidget *modify, int menu, int item)
{
  ...
  if (item < 0) {
    ...
    pixmap = MyCreateGdkPixmapFromData(empty, modify_preview_frame, &mask);
    gtk_pixmap_set (GTK_PIXMAP(modify_preview_pixmap), pixmap, mask);
    gtk_widget_hide (modify_remove_button);
    signal_id1 = gtk_signal_connect (GTK_OBJECT (modify_ok_button), "clicked",
				 GTK_SIGNAL_FUNC (modify_add_cb),
				 (gpointer) (menu * NBMAXITEMS));

    signal_id2 = gtk_signal_connect (GTK_OBJECT (modify_remove_button), "clicked",
				 GTK_SIGNAL_FUNC (modify_cancel_cb),
				 (gpointer) (menu * NBMAXITEMS));
  }
  else {
    ...
    if (check_file_exists ("/", pixfile)) {
      ...
      gtk_entry_set_text(GTK_ENTRY(modify_icon_entry), _("Default"));
