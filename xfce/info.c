...
void info_private_ok_cb (GtkWidget *twidget)
{
...
create_info (XFCE_palette *pal)
{
  ...
  info_copyright_label = gtk_label_new (_("By Olivier Fourdan (c) 1997, 1998, 1999"));
  ...
  /* gtk_widget_set_style(info_license_text, pal->cm[4]); */
  ...
  info_agreement_button = gtk_button_new_with_label (_("Agreement"));
  ...
  gtk_signal_connect_object (GTK_OBJECT (info_agreement_button), "clicked",
				 GTK_SIGNAL_FUNC (info_private_ok_cb),
				 NULL);
