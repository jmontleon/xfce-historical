...
GtkWidget *create_popup_item (GtkWidget * toplevel, XFCE_palette * pal,
			      gint nbr_menu, gint nbr_item);

GtkWidget *create_popup_menu (XFCE_palette * pal, gint nbr);

void create_all_popup_menus (XFCE_palette * pal, GtkWidget * main);
...
int get_popup_menu_entries (gint menu);
