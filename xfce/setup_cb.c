...
void toggle_digital_clock_checkbutton_cb( GtkWidget *widget,
                       gpointer   data )
{
  gtk_widget_set_sensitive(GTK_WIDGET (setup_options.setup_hrs_mode_checkbutton), 
                           (gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON (setup_options.setup_digital_clock_checkbutton))));
