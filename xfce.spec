...
%build
./configure --prefix=%{prefix} --datadir=%{datadir} --disable-dt
make
...
chmod 0755 $RPM_BUILD_ROOT%{datadir}/xfce/{sample.xsession,sample.xinitrc,sample.Xclients}
